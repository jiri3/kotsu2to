...
export type MarkdownRemarkFrontmatterUpdatedateArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type PokemonConnection = {
  ...
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<PokemonGroupConnection>;
};


export type PokemonConnectionDistinctArgs = {
  field: PokemonFieldsEnum;
};


export type PokemonConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: PokemonFieldsEnum;
};
...
export type PokemonEdge = {
  next?: Maybe<Pokemon>;
  node: Pokemon;
  previous?: Maybe<Pokemon>;
};

export type PokemonFieldsEnum = 
  | 'id'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
...
export type PokemonGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<PokemonEdge>;
  nodes: Array<Pokemon>;
  pageInfo: PageInfo;
...
export type PokemonSortInput = {
  fields?: Maybe<Array<Maybe<PokemonFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type SiteFieldsEnum = 
  ...
  | 'siteMetadata___yearOfPublished'
  | 'siteMetadata___topPage'
...
export type SiteSiteMetadata = {
  title?: Maybe<Scalars['String']>;
  yearOfPublished?: Maybe<Scalars['Int']>;
  topPage?: Maybe<Scalars['String']>;
...
export type SiteSiteMetadataFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  yearOfPublished?: Maybe<IntQueryOperatorInput>;
  topPage?: Maybe<StringQueryOperatorInput>;
...
export type BioQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'base64' | 'width' | 'height' | 'src' | 'srcSet'>> }> }>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'summary'>>, social?: Maybe<Pick<SiteSiteMetadataSocial, 'twitter'>> }> }> };

export type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_1_Query = { allSitePage: { nodes: Array<(
      Pick<SitePage, 'path'>
      & { context?: Maybe<Pick<SitePageContext, 'pageTitle'>> }
    )> }, site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'topPage'>> }> };

export type Unnamed_2_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_2_Query = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'yearOfPublished'>
...
export type MenuQuery = { site?: Maybe<{ siteMetadata?: Maybe<{ menu?: Maybe<Array<Maybe<Pick<SiteSiteMetadataMenu, 'name' | 'url'>>>> }> }> };

export type Unnamed_3_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_3_Query = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'siteImage'>
...
export type IndexPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'topPage'>> }>, allMarkdownRemark: { group: Array<{ nodes: Array<(
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'description' | 'tags' | 'category'>> }
      )> }> } };
...
export type BlogPostQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, markdownRemark?: Maybe<(
...
export type CategoryIndexQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'topPage'>> }>, allMarkdownRemark: (
...
export type TagPageBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'topPage'>> }>, allMarkdownRemark: { edges: Array<{ node: { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'description' | 'tags'>> } }> } };
